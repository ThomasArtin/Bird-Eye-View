 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Apr 15 19:01:29 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME multiplier4
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void multiplier4_Outputs_wrapper(const real_T *u0,
			int32_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    multiplier4_Outputs_wrapper(u0, y0);
}

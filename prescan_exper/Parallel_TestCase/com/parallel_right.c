 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Mar 27 22:38:29 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME parallel_right
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void parallel_right_Outputs_wrapper(const real_T *Front,
			const real_T *LEFT,
			const real_T *RIGHT,
			const real_T *BACK,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    parallel_right_Outputs_wrapper(Front, LEFT, RIGHT, BACK, current_v, parallel_r, steering, velocity, brake, Trottle, counter, counter1, counter2, counter3, counter4, counter5, autog);
}

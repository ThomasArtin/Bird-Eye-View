 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Mar 25 13:19:46 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME new_s
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  7 */
#define IN_PORT_7_NAME        parallel_r
...
extern void new_s_Outputs_wrapper(const real_T *Front,
			const real_T *LEFT,
			const real_T *RIGHT,
			const real_T *BACK,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *X = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *Y = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *parallel_r = (real_T *) ssGetInputPortRealSignal(S, 7);
    ...
    real_T *autog = (real_T *) ssGetOutputPortRealSignal(S, 9);

    new_s_Outputs_wrapper(Front, LEFT, RIGHT, BACK, current_v, X, Y, parallel_r, steering, velocity, brake, Trottle, counter, counter1, counter2, counter3, counter4, autog);
}

 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Mar 27 21:37:02 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME slot_detection
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  3 */
#define IN_PORT_3_NAME        current_v
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       parallel_r
...
/* Output Port  6 */
#define OUT_PORT_6_NAME       parallel_l
...
/* Output Port  9 */
#define OUT_PORT_9_NAME       counter3
...
/* Output Port  10 */
#define OUT_PORT_10_NAME       direction
...
extern void slot_detection_Outputs_wrapper(const real_T *Front,
			const real_T *LEFT,
			const real_T *RIGHT,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *current_v = (real_T *) ssGetInputPortRealSignal(S, 3);
    ...
    real_T *autog = (real_T *) ssGetOutputPortRealSignal(S, 4);
    real_T *parallel_r = (real_T *) ssGetOutputPortRealSignal(S, 5);
    real_T *parallel_l = (real_T *) ssGetOutputPortRealSignal(S, 6);
    real_T *perp_r = (real_T *) ssGetOutputPortRealSignal(S, 7);
    real_T *perp_l = (real_T *) ssGetOutputPortRealSignal(S, 8);
    real_T *counter3 = (real_T *) ssGetOutputPortRealSignal(S, 9);
    real_T *direction = (real_T *) ssGetOutputPortRealSignal(S, 10);

    slot_detection_Outputs_wrapper(Front, LEFT, RIGHT, current_v, steering, velocity, brake, Trottle, autog, parallel_r, parallel_l, perp_r, perp_l, counter3, direction);
}

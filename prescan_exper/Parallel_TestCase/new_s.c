 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Mar 24 16:30:08 2021
 */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *autog = (real_T *) ssGetOutputPortRealSignal(S, 8);

    new_s_Outputs_wrapper(Front, LEFT, RIGHT, BACK, current_v, X, Y, steering, velocity, brake, Trottle, counter, counter1, counter2, counter3, autog);
}
